...
public class ListContactAdapter extends BaseAdapter {
	...
	private void setValues(ViewHolder holder, int position) {
		...
		holder.imgAvatar.setImageResource(mListContacts.get(position)
				.getmIdAvatar());
	...
	private void doActionButton(ViewHolder holder, final int position) {
		...
		// button delete
		holder.imgBtnDelete.setOnClickListener(new OnClickListener() { // Button
																		// Delete
																		// Event
	...
	public void showDialog(final int position) {
		...
		alert.setMessage(
				"Are you sure want to delete "
						+ mListContacts.get(position).getmName())
